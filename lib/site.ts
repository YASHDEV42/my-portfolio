...
type ProjectSource = Omit<Project, "tagline" | "role" | "category" | "problem" | "contribution" | "decisions" | "outcome" | "videos"> & {
...
const projects: ProjectSource[] = [
  ...
  },
  {
    ...
    videos: [
      { youtubeId: "DeN11dVsTZU", url: "https://youtu.be/DeN11dVsTZU" },
    ],
  ...
  },
  {
    ...
    videos: [
      { youtubeId: "DhGAmZbGHws", url: "https://youtu.be/DhGAmZbGHws" },
    ],
    stack: ["Next.js 14", "TypeScript", "Prisma", "PostgreSQL", "Stripe", "NextAuth"],
  },
  {
    slug: "yashtask",
    name: "YASHTASK",
    ...
    videos: [
      { youtubeId: "ICznpDFLNyA", url: "https://youtu.be/ICznpDFLNyA" },
    ],
    stack: ["Next.js 14", "TypeScript", "MongoDB", "NextAuth", "AI SDK", "Gemini"],
  },
  {
    slug: "quizyourself",
    name: "QuizYourself",
    ...
    videos: [
      { youtubeId: "xB3FiK5dfVQ", url: "https://youtu.be/xB3FiK5dfVQ" },
    ],
...
export function getProjects(t: Translate): Project[] {
  return projects.map((project) => {
    ...
    return {
      ...
      decisions: [t(`${key}.decision1`), t(`${key}.decision2`), t(`${key}.decision3`)],
